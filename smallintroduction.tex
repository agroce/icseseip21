...
of all the generated mutants.   Fuzzing adds only two unique mutant kills beyond those produced by
functional testing, which has a much higher mutation score.  This raises the question:  why fuzz?  The coverage for high quality
...
almost never detect,
e.g. \url{https://github.com/bitcoin/bitcoin/issues/22450}.

To put our work on Bitcoin in context, we performed mutation analysis
of transaction-verification-related code for other popular cryptocurrencies, and Bitcoin ranked high: 2nd out of 6 projects. Bitcoin Core
