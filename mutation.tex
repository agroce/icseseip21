...
The universal mutator generated 430 compiling mutants of the file.\rvt{rvt asks:
  it would be nice if we could say ``We ran universal mutator for X hours which
  generated 430 ....'', as a reader I find myself wondering how long this took.}
...
\cmidrule{2-7}
\mr{3}{solana}                  & perf/src/sigverify.rs                         & 1246             & ????\%                  & 74.48\%                 & \mr{3}{82.2\%}           &  \mr{3}{02/2018}                    \\
...
\cmidrule{2-7}
go-algorand                     & ledger/eval.go                                & 1551             & 99.8\%                  & 86.0\%                  & 52.2\%                   & 06/2019                               \\
\cmidrule{2-7}
...
\subsubsection*{Limitations.} One potential limitation of our analysis is the selection of files relating to transaction and block validation. While our heuristics and manual inspection did lead us to files that fulfilled these
