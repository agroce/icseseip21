...
of all the generated mutants. This is not a bad result: fuzzing inherently has
...
for each file and the entire project. In principle, we expect that higher file coverage
