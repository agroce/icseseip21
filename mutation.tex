...
room to improve functional test coverage (and mutation score) across popular
cryptocurrencies.
...
conduct such evaluations comprehensively: (1) identifying critical blockhain
functionality and evaluating associated test coverage
(2) understanding why there are gaps in coverage exist (is it a lack of
tests, or does other kind of testing take place (e.g., integration testing)
that doesn't visibly reveal coverage? Moreover, projects
 It was difficult even to obtain code coverage data for
those projects that do not report it via continuous integration.
\clg{Pithy summary/call to arms? I'd love for Rijnard to give it a shot,
  honestly, I think he has a better vision here.} Said shortly, with
cryptocurrency projects seeking to unabashedly upend the status quo of financial
